...
export const botReplies: Record<string, string> = {
    ...
    "Just saying hello!": "Hello there! 👋 Thanks for stopping by.",
    "Interested in mentorship":
      "Awesome! Sergio loves mentoring. Please reach out through the contact form!",
    "We'd like to hire you":
      "That's great! 🚀 You can contact Sergio directly via the contact page.",
};